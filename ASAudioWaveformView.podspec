...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ASAudioWaveformView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Andrew Shen/ASAudioWaveformView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Andrew Shen' => 'iandrew@126.com' }
  s.source           = { :git => 'https://github.com/Andrew Shen/ASAudioWaveformView.git', :tag => s.version.to_s }
